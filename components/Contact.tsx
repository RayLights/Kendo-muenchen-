    ...
    >
      <div className="grid gap-6 md:grid-cols-3">
        <a
          ...
          className="flex items-start gap-4 rounded-2xl border border-line bg-paper p-6 shadow-sm transition-colors hover:border-crimson/40"
        >
          <MailIcon className="h-6 w-6 shrink-0 text-crimson" />
          <span>
        ...
        <div className="flex items-start gap-4 rounded-2xl border border-line bg-paper p-6 shadow-sm">
          <PinIcon className="h-6 w-6 shrink-0 text-crimson" />
          <span>
            <span className="block font-display font-semibold text-navy">
              Training
            </span>
        ...
        <div className="flex items-start gap-4 rounded-2xl border border-line bg-paper p-6 shadow-sm">
          <span className="flex gap-2">
            <InstagramIcon className="h-6 w-6 shrink-0 text-crimson" />
          </span>
          <span>
            <span className="block font-display font-semibold text-navy">
              Social Media
            ...
            <span className="mt-1 flex flex-col gap-1.5 text-sm">
              <a
                ...
                className="inline-flex items-center gap-2 text-ink/75 hover:text-crimson"
              >
